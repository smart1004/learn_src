...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='D:/home/lstm_tensorflow/word-rnn-tensorflow/data/tinyshakespeare',
                       help='data directory containing input.txt')
    parser.add_argument('--input_encoding', type=str, default=None,
                       help='character encoding of input.txt, from https://docs.python.org/3/library/codecs.html#standard-encodings')
    parser.add_argument('--log_dir', type=str, default='logs',
                       help='directory containing tensorboard logs')
    parser.add_argument('--save_dir', type=str, default='D:/home/lstm_tensorflow/word-rnn-tensorflow/save',
